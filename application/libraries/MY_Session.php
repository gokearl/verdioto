...
require('application/libraries/predis-1.0/autoload.php');
...
class MY_Session extends CI_Session implements SessionHandlerInterface {
    ...
    private $prefix;
    private $redis;
    private $redis_config = ['scheme' => 'tcp', 'host' => 'redis://h:pb4714986433f567033f960e418d8a74c35ab0394c33288b6ab722a886df5ef7e@ec2-176-34-114-19.eu-west-1.compute.amazonaws.com', 'port' => '6379'];
